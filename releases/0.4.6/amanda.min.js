...
b,c,d,e){c&&(a=v(b),b=(k(b)||h(b)||g(b))&&m(b),(a||b)&&this.addError());return e()});f.prototype.addAttributeConstructor("type",function(){var a={string:k,number:p,"function":u,"boolean":C,object:g,array:h,integer:x,"int":x,"null":D,any:E};return function(b,c,d,e,f){if(h(d)){if(!Array.prototype.every.apply(d,[function(b){return Object.prototype.hasOwnProperty.apply(a,[b])}]))return this.addError("One of the following types \u2018"+d.join(",")+"\u2019 is not supported."),f();d.some(function(b){return a[b](c)})||
this.addError()}else Object.prototype.hasOwnProperty.apply(a,[d])?a[d](c)||this.addError():this.addError("Type \u2018"+d+"\u2019 is not supported.");return f()}});f.prototype.addAttribute("uniqueItems",function(a,b,c,d,e){var f=this;j(b,function(c,e){k(e)&&b.indexOf(e)<c&&f.addError();(g(e)||h(e))&&b.forEach(function(b,d){d!==c&&w(e,b)&&f.addError({property:f.joinPath(a,d)})})});return e()});var r=function(a){this.length=0;this.errorMessages=a.messages};r.prototype.renderErrorMessage=function(a){var b=
this.errorMessages[a.attributeName];return b&&u(b)?b(a.property,a.propertyValue,a.attributeValue):b&&k(b)?(["property","propertyValue","attributeValue"].forEach(function(c){b=b.replace(RegExp("{{"+c+"}}","g"),a[c])}),b=b.replace(/{{validator}}/g,a.attributeValue),b.replace(/\s+/g," ")):a.message};r.prototype.push=function(a){this[this.length]={property:a.property,propertyValue:a.propertyValue,attributeName:a.attributeName,attributeValue:a.attributeValue,message:this.renderErrorMessage(a),validator:a.attributeName,
validatorName:a.attributeName,validatorValue:a.attributeValue};this.length+=1};r.prototype.getProperties=function(){return z(this,"property")};r.prototype.getMessages=function(){return z(this,"message")};var F={required:function(a){return"The \u2018"+a+"\u2019 property is required."},minLength:function(a,b,c){return["The "+a+" property must be at least "+c+" characters.","The length of the property is "+b.length+"."].join(" ")},maxLength:function(a,b,c){return["The "+a+" property must not exceed "+
c+" character"+(1<c?"s":"")+".","The length of the property is "+b.length+"."].join(" ")},length:function(a,b,c){return["The "+a+" property must be exactly "+c+" character"+(1<c?"s":"")+".","The length of the property is "+b.length+"."].join(" ")},format:function(a,b,c){return["The \u2018"+a+"\u2019 property must be a/an \u2018"+c+"\u2019.","The current value of the property is \u2018"+b+"\u2019"].join(" ")},type:function(a,b,c){return["The \u2018"+a+"\u2019 property must be "+(-1<"aeiou".indexOf(c[0])?
"an":"a")+" \u2018"+c+"\u2019.","The type of the property is \u2018"+typeof b+"\u2019"].join(" ")},except:function(){},minimum:function(a,b,c){return["The minimum value of the \u2018"+a+"\u2019 must be "+c+".","The current value of the property is \u2018"+b+"\u2019"].join(" ")},maximum:function(a,b,c){return["The maximum value of the \u2018"+a+"\u2019 must be "+c+".","The current value of the property is \u2018"+b+"\u2019."].join(" ")},pattern:function(a,b,c){return"The \u2018"+a+"\u2019 does not match the \u2018"+
c+"\u2019 pattern."},maxItems:function(a,b,c){return["The \u2018"+a+"\u2019 property must not contain more than \u2018"+c+"\u2019 items.","Currently it contains \u2018"+b.items+"\u2019 items."].join(" ")},minItems:function(a,b,c){return["The \u2018"+a+"\u2019 property must contain at least \u2018"+c+"\u2019 items.","Currently it contains \u2018"+b.items+"\u2019 items."].join(" ")},divisibleBy:function(a,b,c){return"The \u2018"+a+"\u2019 is not divisible by \u2018"+c+"\u2019."},uniqueItems:function(a){return"All items in the \u2018"+
a+"\u2019 property must be unique."},"enum":function(a,b,c){return"Value of the \u2018"+a+"\u2019 must be "+c.join(" or ")+"."}};f.prototype.getProperty=function(a,b){if(b)return t(b[a])?b[a]:void 0};f.prototype.joinPath=function(a,b){a=a||"";b+="";return b.match(/^[a-zA-Z_][a-zA-Z0-9_]*$/)?a?a+"."+b:b:b.match(/^\d+$/)?a+"["+b+"]":a+'["'+b+'"]'};f.prototype.validate=function(a,b,c){var d=this;this.instance=a;this.schema=b;var e=function(){return 0!==d.errors.length?c(d.errors):c()};if(-1!=="string number function boolean integer int null".split(" ").indexOf(b.type))return this.validateProperty(void 0,
