...
a+"\u2019 property must be unique."},"enum":function(a,b,c){return"Value of the \u2018"+a+"\u2019 must be "+c.join(" or ")+"."}};f.prototype.getProperty=function(a,b){if(b)return t(b[a])?b[a]:void 0};f.prototype.joinPath=function(a,b){a=a||"";b+="";return b.match(/^[a-zA-Z][a-zA-Z0-9]*$/)?a?a+"."+b:b:b.match(/\d+/)?a+"["+b+"]":a+'["'+b+'"]'};f.prototype.validate=function(a,b,c){var d=this;this.instance=a;this.schema=b;var e=function(){return 0!==d.errors.length?c(d.errors):c()};if(-1!=="string number function boolean integer int null".split(" ").indexOf(b.type))return this.validateProperty(void 0,
